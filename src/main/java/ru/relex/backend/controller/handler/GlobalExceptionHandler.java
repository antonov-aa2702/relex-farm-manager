...
public class GlobalExceptionHandler {
     ...
     * Некорректное состояние возникает при работе с ресурсами, которые находятся в некорректном состоянии.
     * Например, при добавлении сотрудника с уже существующим идентификатором.
     *
