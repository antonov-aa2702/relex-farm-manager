...
public interface ManufacturedProductService {
     ...
     * собрать согласно норме и сколько произведено на текущий момент, а также крайни срок добавления продукта.
     *
     * @param productDto продукт, который будет добавлен
     * @param employeeId идентификатор сотрудника, который добавляет продукт
     * @return данные, содержащие информацию новом о состоянии рабочей нормы после добавления продукта
     ...
     */
    WorkingNormDto produceProduct(ManufacturedProductDto productDto, Long employeeId) throws ResourceIllegalStateException;
}
